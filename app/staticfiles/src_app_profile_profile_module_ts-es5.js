(function () {
  ...
  (self["webpackChunkendless"] = self["webpackChunkendless"] || []).push([["src_app_profile_profile_module_ts"], {
    /***/
    56018: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_transactions_transaction_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! src/app/transactions/transaction.service */
      25171);
      /* harmony import */


      var src_app_shared_services_profile_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      function EditProfileComponent_form_14_div_25_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var _c0 = function _c0() {
        return ["/transactions/topup-personal"];
      };

      function EditProfileComponent_form_14_ng_container_27_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditProfileComponent_form_14_ng_container_28_i_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelement"](0, "i", 35);
        }
      }

      function EditProfileComponent_form_14_ng_container_28_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var _c1 = function _c1(a0, a1) {
        return {
          "icofont icofont-pencil-alt-5": a0,
          "fa fa-spin fa-cog": a1
        };
      };
      ...
      function EditProfileComponent_form_14_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("change", function EditProfileComponent_form_14_Template_input_change_5_listener($event) {
            _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵrestoreView"](_r10);

            var ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵnextContext"]();

            return ctx_r9.readUrl($event);
          });
      ...
      function EditProfileComponent_form_17_div_16_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditProfileComponent_form_17_div_22_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "div", 44);
      ...
      function EditProfileComponent_form_17_i_25_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelement"](0, "i", 45);
        }
      }

      function EditProfileComponent_form_17_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("submit", function EditProfileComponent_form_17_Template_form_submit_0_listener() {
      ...
      function EditProfileComponent_form_19_div_21_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditProfileComponent_form_19_div_21_small_2_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EditProfileComponent_form_19_div_21_small_3_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "small", 51);
      ...
      function EditProfileComponent_form_19_div_21_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "div");
      ...
      function EditProfileComponent_form_19_div_27_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "div", 44);
      ...
      function EditProfileComponent_form_19_i_30_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelement"](0, "i", 45);
        }
      }

      function EditProfileComponent_form_19_Template(rf, ctx) {
        if (rf & 1) {
          var _r23 = _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵgetCurrentView"]();

          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵelementStart"](0, "form", 36);

          _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵlistener"]("submit", function EditProfileComponent_form_19_Template_form_submit_0_listener() {
      ...
      var _EditProfileComponent = /*#__PURE__*/function () {
        ...
        function _EditProfileComponent(helperService, authService, fb, transactionService, profileService) {
        ...
        _createClass(_EditProfileComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.authService.getProfileListener().subscribe(function (isLoading) {
              _this.isLoading = isLoading;
              isLoading ? null : _this.getUserInfo();
            });
            this.getUserInfo();
            this.getuserGroup();
          }
          ...
          value: function testUrl(event) {
            ...
            reader.onload = function () {
              console.log(file); // imagePreview = reader.result as string;
              // images.push(file);
              // images.push(file);
          ...
          value: function getuserGroup() {
            ...
            switch (userGroup) {
              ...
              case "ven":
                this.isVend = true; // this.getCompanyArray()
          ...
          value: function getUserInfo() {
            ...
            this.profileSubb = this.profileService.getUSerInfo().subscribe(function (userInfo) {
              var _a, _b;

              console.log(userInfo);
              _this3.userInfo = userInfo;
              _this3.userForm = _this3.fb.group({
                first_name: [(_a = _this3.userInfo) === null || _a === void 0 ? void 0 : _a.first_name, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required],
                last_name: [(_b = _this3.userInfo) === null || _b === void 0 ? void 0 : _b.last_name, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required]
              });
              _this3.passwordForm = _this3.fb.group({
                old_password: ["", _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required],
                new_password: ["", [_angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.required, _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.minLength(8), _angular_forms__WEBPACK_IMPORTED_MODULE_5__.Validators.pattern(_this3.passwordRegex)]],
    ...
    84523: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](_ProfileModule, {
          declarations: [_edit_profile_edit_profile_component__WEBPACK_IMPORTED_MODULE_1__.EditProfileComponent],
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__.CommonModule, _angular_forms__WEBPACK_IMPORTED_MODULE_4__.ReactiveFormsModule, _profile_routing_module__WEBPACK_IMPORTED_MODULE_0__.ProfileRoutingModule]
        });
      })();
      /***/
    ...
    /***/
    96893: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      __webpack_require__.r(__webpack_exports__);
      /* harmony export */
      ...
      var _ProfileService = /*#__PURE__*/function () {
        function _ProfileService(http, notificationService, errorService) {
        ...
        _createClass(_ProfileService, [{
          ...
          value: function getUSerInfo() {
            ...
            this.http.get("".concat(this.apiUrl, "auth/user-info/")) // .pipe(shareReplay())
            .subscribe(function (res) {
              _this4.userInfo = res;

              _this4.userInfoListener.next(_this4.userInfo);
            }, function (err) {
              _this4.notificationService.warning("Error", "Failed to load user info");

              _this4.userInfoListener.next(null);
            });
      ...
      _ProfileService.ɵfac = function ProfileService_Factory(t) {
        return new (t || _ProfileService)(_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_5__.HttpClient), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_notification_service__WEBPACK_IMPORTED_MODULE_1__.NotificationService), _angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵinject"](_error_service__WEBPACK_IMPORTED_MODULE_2__.ErrorService));
      };

      _ProfileService.ɵprov = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_4__["ɵɵdefineInjectable"]({
