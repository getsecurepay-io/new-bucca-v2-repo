...
/* harmony import */ var _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/cdk/collections */ 62604);
...
/* harmony import */ var _angular_cdk_platform__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular/cdk/platform */ 36145);
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! rxjs */ 64674);
...
let CdkTable = /*#__PURE__*/(() => {
  class CdkTable {
    ...
    renderRows() {
      ...
      const viewContainer = this._rowOutlet.viewContainer; // @breaking-change 11.0.0 Remove null check for `_viewRepeater` and the
...
const MAT_SORT_DEFAULT_OPTIONS = /*#__PURE__*/new _angular_core__WEBPACK_IMPORTED_MODULE_0__.InjectionToken('MAT_SORT_DEFAULT_OPTIONS'); // Boilerplate for applying mixins to MatSort.

/** @docs-private */

class MatSortBase {}

const _MatSortMixinBase = /*#__PURE__*/(0,_angular_material_core__WEBPACK_IMPORTED_MODULE_1__.mixinInitialized)( /*#__PURE__*/(0,_angular_material_core__WEBPACK_IMPORTED_MODULE_1__.mixinDisabled)(MatSortBase));
...
const _MatSortHeaderMixinBase = /*#__PURE__*/(0,_angular_material_core__WEBPACK_IMPORTED_MODULE_1__.mixinDisabled)(MatSortHeaderBase);
/**
...
let MatSortHeader = /*#__PURE__*/(() => {
  class MatSortHeader extends _MatSortHeaderMixinBase {
    constructor(_intl, _changeDetectorRef, // `MatSort` is not optionally injected, but just asserted manually w/ better error.
    // tslint:disable-next-line: lightweight-tokens
...
/* harmony import */ var _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/cdk/collections */ 62604);
...
/* harmony import */ var src_app_shared_services_notification_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! src/app/shared/services/notification.service */ 97161);
/* harmony import */ var _shared_services_error_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../shared/services/error.service */ 44578);
...
let UserService = /*#__PURE__*/(() => {
  class UserService {
    constructor(http, router, notificationService, errorService) {
      this.http = http;
      this.router = router;
    ...
    getCompanyList(pageSize = 10, pageIndex = 0) {
      ...
      this.http.get(`${this.apiUrl}auth/companys/${query}`).subscribe(res => {
        this.companyList = res;
        this.companysListener.next(Object.assign({}, this.companyList));
      }, err => {});
    }
    ...
    createCompany(formData) {
      ...
      this.http.post(`${this.apiUrl}auth/companys/`, formData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(response => {
        this.isLoadingListener.next(false);
        this.notificationService.success(`Success`, `Company onboard successful`);
        this.router.navigate(["/user/company-list"]);
      }, err => {
        console.log(err);
        const errorMessage = err.error.message || err.error.details || err.error.error;
    ...
    uploadStaff(employees) {
      this.http.post(`${this.apiUrl}auth/bulk-employee/`, employees).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(response => {
        console.log(response);
        this.isLoadingListener.next(false);
        this.notificationService.success(`Successful`, `User(s) account created`);
        this.router.navigate(["/user/staff-list"]);
      }, err => {
        console.log(err);
        console.log(err.error);
        this.staffsCreateErrorListener.next(err.error); // this.notificationService.danger(`Error`, `An unknown error occured`);
    ...
    deactivateUser(user) {
      ...
      this.http.post(`${this.apiUrl}auth/change-user-status/`, {
    ...
    getCompanyAdminList(pageSize = 10, pageIndex = 0, company) {
      ...
      this.http.get(`${this.apiUrl}auth/cmp-adm/${query}`).subscribe(res => {
        this.companyAdminList = res;
        this.companyAdminListener.next(Object.assign({}, this.companyAdminList));
      }, err => {});
    }
    ...
    createCompanyAdmin(formData) {
      ...
      this.isLoadingListener.next(true);
      this.http.post(`${this.apiUrl}auth/cmp-adm/`, formData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(response => {
    ...
    getAccountantList(pageSize = 10, pageIndex = 0, company) {
      const query = `?limit=${pageSize}&offset=${pageIndex}&${company ? "&company=" + company : ""}`;
      this.http.get(`${this.apiUrl}auth/cmp-act/${query}`).subscribe(res => {
        this.accountantList = res;
        this.accountantListener.next(Object.assign({}, this.accountantList));
      }, err => {});
    }
    ...
    createAccountant(formData) {
      this.http.post(`${this.apiUrl}auth/cmp-act/`, formData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(response => {
        this.notificationService.success(response.status, response.message);
        this.router.navigate(["/user/accountant-list"]);
      }, err => {
        this.notificationService.danger(`Error`, `An unknown error occured`); // this.errorService.handleError(err.error.message);

        this.errorService.handleError(err.error.message || err.error.details);
      });
    }

    getStaffList(pageSize = 10, pageIndex = 0) {
      const query = `?limit=${pageSize}&offset=${pageIndex}`;
      this.http.get(`${this.apiUrl}auth/staffs/${query}`).subscribe(res => {
        // console.log(res)
        this.staffs = res;
        this.staffsListener.next(Object.assign({}, this.staffs));
      }, err => {});
    }
    ...
    createStaff(formData) {
      this.http.post(`${this.apiUrl}auth/staffs/`, formData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(response => {
        this.notificationService.success(`Success`, `staff account creation successful`);
    ...
    createStaffLevel(formData) {
      console.log(formData);
      this.http.post(`${this.apiUrl}auth/staff-level/`, formData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(response => {
        this.notificationService.success(`Success`, `staff Level creation successful`);
        this.router.navigate(["user/staff-level-list"]);
      }, err => {
        this.errorService.handleError(err.error.message || err.error.details);
        console.log(err);
        this.notificationService.danger(`Error`, `Department creation was unsuccessful`);
        this.notificationService.danger(``, `${err.error.name || err.name}`);
      });
    }

    getStaffLevels() {
      this.http.get(`${this.apiUrl}auth/staff-level/`).subscribe(res => {
        console.log(res);
        this.staffLevels = res;
        this.staffLevelsListener.next(Object.assign({}, this.staffLevels));
      }, err => {});
    ...
    getDepartments(pageSize = 10, pageIndex = 0) {
      const query = `?limit=${pageSize}&offset=${pageIndex}`;
      this.http.get(`${this.apiUrl}auth/departments/${query}`).subscribe(res => {
        this.departments = res;
        this.departmentsListener.next(Object.assign({}, this.departments));
      }, err => {});
    }
    ...
    createDepartment(formData) {
      this.http.post(`${this.apiUrl}auth/departments/`, formData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(response => {
        this.notificationService.success(`Success`, `Department creation successful`);
    ...
    getVendors(pageSize = 10, pageIndex = 0, company = null) {
      const query = `?limit=${pageSize}&offset=${pageIndex}&${company ? "&company=" + company : ""}`;
      this.http.get(`${this.apiUrl}auth/vendor/${query}`).subscribe(res => {
        this.vendors = res;
    ...
    createVendor(formData) {
      this.http.post(`${this.apiUrl}auth/vendor/`, formData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(response => {
        this.notificationService.success(`Success`, `Vendor account creation successful`);
    ...
    getVendorStaffs(pageSize = 10, pageIndex = 0) {
      const query = `?limit=${pageSize}&offset=${pageIndex}`;
      this.http.get(`${this.apiUrl}auth/vendor-staff/${query}`).subscribe(res => {
        this.vendorStaffs = res;
        this.vendorStaffsListener.next(Object.assign({}, this.vendorStaffs));
      }, err => {});
    }
    ...
    createVendorStaff(formData) {
      this.http.post(`${this.apiUrl}auth/vendor-staff/`, formData).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(response => {
        this.notificationService.success(`Success`, `Vendor account creation successful`);
        this.router.navigate(["/user/vendor-staff-list"]);
      }, err => {
        this.notificationService.warning(`Error`, `Account creation was unsuccessful`);
        this.errorService.handleError(err.error.message || err.error.details);
      });
    }
...
//# sourceMappingURL=default-node_modules_angular_material___ivy_ngcc___fesm2015_sort_js-node_modules_angular_mate-9356fd-es2015.js.map