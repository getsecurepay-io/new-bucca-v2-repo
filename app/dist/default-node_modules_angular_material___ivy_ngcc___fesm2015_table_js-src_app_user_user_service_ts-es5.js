(function () {
  ...
  (self["webpackChunkendless"] = self["webpackChunkendless"] || []).push([["default-node_modules_angular_material___ivy_ngcc___fesm2015_table_js-src_app_user_user_service_ts"], {
    /***/
    72306: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _CdkTable = /*#__PURE__*/function () {
        function _CdkTable(_differs, _changeDetectorRef, _elementRef, role, _dir, _document, _platform,
        /**
    ...
    54302: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _MatTable = /*#__PURE__*/function (_angular_cdk_table__W) {
        ...
        var _super12 = _createSuper(_MatTable);
        ...
        function _MatTable() {
          ...
          _this22.stickyCssClass = 'mat-table-sticky';
          /** Overrides the need to add position: sticky on every sticky cell element in `CdkTable`. */

          _this22.needsPositionStickyOnElement = false;
          return _this22;
        }
      ...
      var _MatCellDef = /*#__PURE__*/function (_angular_cdk_table__W2) {
        ...
        var _super13 = _createSuper(_MatCellDef);
      ...
      var _MatHeaderCellDef = /*#__PURE__*/function (_angular_cdk_table__W3) {
        ...
        var _super14 = _createSuper(_MatHeaderCellDef);
      ...
      var _MatFooterCellDef = /*#__PURE__*/function (_angular_cdk_table__W4) {
        ...
        var _super15 = _createSuper(_MatFooterCellDef);
      ...
      var _MatColumnDef = /*#__PURE__*/function (_angular_cdk_table__W5) {
        ...
        var _super16 = _createSuper(_MatColumnDef);
      ...
      var _MatHeaderCell = /*#__PURE__*/function (_angular_cdk_table__W6) {
        ...
        var _super17 = _createSuper(_MatHeaderCell);
      ...
      var _MatFooterCell = /*#__PURE__*/function (_angular_cdk_table__W7) {
        ...
        var _super18 = _createSuper(_MatFooterCell);
      ...
      var _MatCell = /*#__PURE__*/function (_angular_cdk_table__W8) {
        ...
        var _super19 = _createSuper(_MatCell);
      ...
      var _MatHeaderRowDef = /*#__PURE__*/function (_angular_cdk_table__W9) {
        ...
        var _super20 = _createSuper(_MatHeaderRowDef);
      ...
      var _MatFooterRowDef = /*#__PURE__*/function (_angular_cdk_table__W10) {
        ...
        var _super21 = _createSuper(_MatFooterRowDef);
      ...
      var _MatRowDef = /*#__PURE__*/function (_angular_cdk_table__W11) {
        ...
        var _super22 = _createSuper(_MatRowDef);
      ...
      var _MatHeaderRow = /*#__PURE__*/function (_angular_cdk_table__W12) {
        ...
        var _super23 = _createSuper(_MatHeaderRow);
      ...
      var _MatFooterRow = /*#__PURE__*/function (_angular_cdk_table__W13) {
        ...
        var _super24 = _createSuper(_MatFooterRow);
      ...
      var _MatRow = /*#__PURE__*/function (_angular_cdk_table__W14) {
        ...
        var _super25 = _createSuper(_MatRow);
      ...
      var _MatNoDataRow = /*#__PURE__*/function (_angular_cdk_table__W15) {
        ...
        var _super26 = _createSuper(_MatNoDataRow);
      ...
      var _MatTextColumn = /*#__PURE__*/function (_angular_cdk_table__W16) {
        ...
        var _super27 = _createSuper(_MatTextColumn);
      ...
      var _MatTableDataSource3 = /*#__PURE__*/function (_angular_cdk_collecti) {
        ...
        var _super28 = _createSuper(_MatTableDataSource3);
        ...
        function _MatTableDataSource3() {
          ...
          _this23._renderData = new rxjs__WEBPACK_IMPORTED_MODULE_4__.BehaviorSubject([]);
          /** Stream that emits when a new filter string is set on the data source. */

          _this23._filter = new rxjs__WEBPACK_IMPORTED_MODULE_4__.BehaviorSubject('');
          /** Used to react to internal changes of the paginator that are made by the data source itself. */

          _this23._internalPageChanges = new rxjs__WEBPACK_IMPORTED_MODULE_5__.Subject();
          /**
           * Subscription to the changes that should trigger an update to the table's rendered rows, such
           * as filtering, sorting, pagination, or base data changes.
           */

          _this23._renderChangesSubscription = null;
          /**
          ...
          _this23.sortingDataAccessor = function (data, sortHeaderId) {
          ...
          _this23.sortData = function (data, sort) {
            ...
            return data.sort(function (a, b) {
              var valueA = _this23.sortingDataAccessor(a, active);

              var valueB = _this23.sortingDataAccessor(b, active); // If there are data in the column that can be converted to a number,
          ...
          _this23.filterPredicate = function (data, filter) {
          ...
          _this23._data = new rxjs__WEBPACK_IMPORTED_MODULE_4__.BehaviorSubject(initialData);

          _this23._updateChangeSubscription();
        ...
        _createClass(_MatTableDataSource3, [{
          ...
          value: function _updateChangeSubscription() {
            ...
            var filteredData = (0, rxjs__WEBPACK_IMPORTED_MODULE_9__.combineLatest)([dataStream, this._filter]).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.map)(function (_ref) {
              ...
              return _this24._filterData(data);
            ...
            var orderedData = (0, rxjs__WEBPACK_IMPORTED_MODULE_9__.combineLatest)([filteredData, sortChange]).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_10__.map)(function (_ref3) {
              ...
              return _this24._orderData(data);
          ...
          value: function _filterData(data) {
            ...
            this.filteredData = this.filter == null || this.filter === '' ? data : data.filter(function (obj) {
              return _this25.filterPredicate(obj, _this25.filter);
            });
          ...
          value: function _updatePaginator(filteredDataLength) {
            ...
            Promise.resolve().then(function () {
              var paginator = _this26.paginator;
              ...
              if (paginator.pageIndex > 0) {
                ...
                if (newPageIndex !== paginator.pageIndex) {
                  ...
                  _this26._internalPageChanges.next();
                }
              }
            });
          }
      ...
      var _MatTableDataSource2 = /*#__PURE__*/function (_MatTableDataSource4) {
        ...
        var _super29 = _createSuper(_MatTableDataSource2);
    ...
    1584: function _(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
      ...
      var _UserService = /*#__PURE__*/function () {
        function _UserService(http, router, notificationService, errorService) {
          ...
          this.deviceList = new _shared_models_response_model__WEBPACK_IMPORTED_MODULE_1__.PaginatedResponse();
          this.devicesListener = new rxjs__WEBPACK_IMPORTED_MODULE_4__.Subject();
        ...
        _createClass(_UserService, [{
          ...
          value: function getCompanyList() {
            ...
            this.http.get("".concat(this.apiUrl, "auth/companys/").concat(query)).subscribe(function (res) {
              _this27.companyList = res;

              _this27.companysListener.next(Object.assign({}, _this27.companyList));
            }, function (err) {});
          }
        }, {
          ...
          value: function createCompany(formData) {
            ...
            this.http.post("".concat(this.apiUrl, "auth/companys/"), formData).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(function (response) {
              _this28.isLoadingListener.next(false);

              _this28.notificationService.success("Success", "Company onboard successful");

              _this28.router.navigate(["/user/company-list"]);
            }, function (err) {
              console.log(err);
              var errorMessage = err.error.message || err.error.details || err.error.error;

              _this28.notificationService.danger("Error", errorMessage);

              _this28.isLoadingListener.next(false);

              _this28.errorService.handleError(errorMessage);
            });
          }
        }, {
          key: "getDeviceList",
          value: function getDeviceList() {
            ...
            var pageIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
            var query = "?limit=".concat(pageSize, "&offset=").concat(pageIndex);
            this.http.get("".concat(this.apiUrl, "auth/devices/").concat(query)).subscribe(function (res) {
              _this29.deviceList = res;

              _this29.devicesListener.next(Object.assign({}, _this29.deviceList));
            }, function (err) {});
          }
        }, {
          key: "getDeviceListUpdate",
          value: function getDeviceListUpdate() {
            return this.devicesListener.asObservable();
          }
        }, {
          key: "activateDevice",
          value: function activateDevice(device) {
            var _this30 = this;

            console.log(device);
            this.isLoadingListener.next(true);
            this.http.patch("".concat(this.apiUrl, "auth/devices/").concat(device.id, "/"), device).subscribe(function (response) {
              console.log(response);

              _this30.isLoadingListener.next(false);

              _this30.notificationService.success("Success", response.message);
            }, function (err) {
              console.log(err);

              _this30.notificationService.danger("Error", err.error.message);
          ...
          key: "createDevice",
          value: function createDevice(formData, dialogRef) {
            var _this31 = this;

            this.isLoadingListener.next(true); // const company = this.hel

            this.http.post("".concat(this.apiUrl, "auth/devices/"), Object.assign({}, formData)).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(function (response) {
              _this31.isLoadingListener.next(false);

              _this31.notificationService.success("Success", "Device onboard successful");

              dialogRef.close();
            }, function (err) {
              console.log(err);
              var errorMessage = err.error.message || err.error.details || err.error.error || "device code: ".concat(err.error.device_code[0]) || "name: ".concat(err.error.name[0]) || "device id: ".concat(err.error.device_id[0]) || "".concat(err.error.is_active[0]) || err.error.company[0] || err.error.location[0]; // this.notificationService.danger(`Error`, errorMessage);

              _this31.isLoadingListener.next(false);

              _this31.errorService.handleError(errorMessage);
            });
          }
        }, {
          key: "uploadStaff",
          value: function uploadStaff(employees) {
            ...
            this.http.post("".concat(this.apiUrl, "auth/bulk-employee/"), employees).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(function (response) {
              ...
              _this32.notificationService.success("Successful", "User(s) account created");

              _this32.router.navigate(["/user/staff-list"]);
            }, function (err) {
              console.log(err);
              console.log(err.error);

              _this32.staffsCreateErrorListener.next(err.error); // this.notificationService.danger(`Error`, `An unknown error occured`);


              _this32.isLoadingListener.next(false);

              _this32.errorService.handleError(err.error.message || err.error.details);
            });
          }
        }, {
          key: "deactivateUser",
          value: function deactivateUser(user) {
            ...
            this.http.post("".concat(this.apiUrl, "auth/change-user-status/"), {
              ...
              _this33.notificationService.success("Success", response.message);

              _this33.deactivatingListener.next(true);
            }, function (err) {
              console.log(err);

              _this33.notificationService.danger("Error", err.error.message);
          ...
          value: function getCompanyAdminList() {
            ...
            this.http.get("".concat(this.apiUrl, "auth/cmp-adm/").concat(query)).subscribe(function (res) {
              _this34.companyAdminList = res;

              _this34.companyAdminListener.next(Object.assign({}, _this34.companyAdminList));
            }, function (err) {});
          }
        }, {
          ...
          value: function createCompanyAdmin(formData) {
            ...
            this.http.post("".concat(this.apiUrl, "auth/cmp-adm/"), formData).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(function (response) {
              _this35.notificationService.success(response.status, response.message);

              _this35.router.navigate(["/user/company-admin-list"]);

              _this35.isLoadingListener.next(false);
            }, function (err) {
              _this35.notificationService.danger("Error", "An unknown error occured");

              _this35.isLoadingListener.next(false);

              _this35.errorService.handleError(err.error.message || err.error.details);
            });
          }
        }, {
          ...
          value: function getAccountantList() {
            ...
            this.http.get("".concat(this.apiUrl, "auth/cmp-act/").concat(query)).subscribe(function (res) {
              _this36.accountantList = res;

              _this36.accountantListener.next(Object.assign({}, _this36.accountantList));
            }, function (err) {});
          }
        }, {
          ...
          value: function createAccountant(formData) {
            ...
            this.http.post("".concat(this.apiUrl, "auth/cmp-act/"), formData).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(function (response) {
              _this37.notificationService.success(response.status, response.message);

              _this37.router.navigate(["/user/accountant-list"]);
            }, function (err) {
              _this37.notificationService.danger("Error", "An unknown error occured"); // this.errorService.handleError(err.error.message);


              _this37.errorService.handleError(err.error.message || err.error.details);
            });
          }
        }, {
          key: "getStaffList",
          value: function getStaffList() {
            ...
            this.http.get("".concat(this.apiUrl, "auth/staffs/").concat(query)).subscribe(function (res) {
              ...
              _this38.staffsListener.next(Object.assign({}, _this38.staffs));
            }, function (err) {});
          }
        }, {
          ...
          value: function createStaff(formData) {
            ...
            this.http.post("".concat(this.apiUrl, "auth/staffs/"), formData).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(function (response) {
              _this39.notificationService.success("Success", "staff account creation successful");

              _this39.router.navigate(["/staff-list"]);
            }, function (err) {});
          }
        }, {
          ...
          value: function createStaffLevel(formData) {
            ...
            this.http.post("".concat(this.apiUrl, "auth/staff-level/"), formData).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(function (response) {
              _this40.notificationService.success("Success", "staff Level creation successful");

              _this40.router.navigate(["user/staff-level-list"]);
            }, function (err) {
              _this40.errorService.handleError(err.error.message || err.error.details);

              console.log(err);

              _this40.notificationService.danger("Error", "Department creation was unsuccessful");

              _this40.notificationService.danger("", "".concat(err.error.name || err.name));
            });
          }
        }, {
          key: "getStaffLevels",
          value: function getStaffLevels() {
            ...
            this.http.get("".concat(this.apiUrl, "auth/staff-level/")).subscribe(function (res) {
              console.log(res);
              _this41.staffLevels = res;

              _this41.staffLevelsListener.next(Object.assign({}, _this41.staffLevels));
            }, function (err) {});
          ...
          value: function getDepartments() {
            ...
            this.http.get("".concat(this.apiUrl, "auth/departments/").concat(query)).subscribe(function (res) {
              _this42.departments = res;

              _this42.departmentsListener.next(Object.assign({}, _this42.departments));
            }, function (err) {});
          }
        }, {
          ...
          value: function createDepartment(formData) {
            ...
            this.http.post("".concat(this.apiUrl, "auth/departments/"), formData).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(function (response) {
              _this43.notificationService.success("Success", "Department creation successful");

              _this43.router.navigate(["/user/department-list"]);
            }, function (err) {
              _this43.errorService.handleError(err.error.message || err.error.details);

              _this43.notificationService.danger("Error", "Department creation was unsuccessful");

              _this43.notificationService.danger("", "".concat(err.error.name || err.name));
            });
          }
        }, {
          key: "getVendors",
          value: function getVendors() {
            ...
            this.http.get("".concat(this.apiUrl, "auth/vendor/").concat(query)).subscribe(function (res) {
              ...
              _this44.vendorsListener.next(Object.assign({}, _this44.vendors));
            }, function (err) {});
          }
        }, {
          ...
          value: function createVendor(formData) {
            ...
            this.http.post("".concat(this.apiUrl, "auth/vendor/"), formData).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(function (response) {
              _this45.notificationService.success("Success", "Vendor account creation successful");

              _this45.router.navigate(["/user/vendor-list"]);
            }, function (err) {
              var errorMessage = err.error.message || err.error.details || err.error.error;

              _this45.notificationService.danger("Error", errorMessage);

              _this45.errorService.handleError(errorMessage);
            });
          }
        }, {
          key: "getVendorStaffs",
          value: function getVendorStaffs() {
            ...
            this.http.get("".concat(this.apiUrl, "auth/vendor-staff/").concat(query)).subscribe(function (res) {
              _this46.vendorStaffs = res;

              _this46.vendorStaffsListener.next(Object.assign({}, _this46.vendorStaffs));
            }, function (err) {});
          }
        }, {
          ...
          value: function createVendorStaff(formData) {
            ...
            this.http.post("".concat(this.apiUrl, "auth/vendor-staff/"), formData).pipe((0, rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.shareReplay)()).subscribe(function (response) {
              _this47.notificationService.success("Success", "Vendor account creation successful");

              _this47.router.navigate(["/user/vendor-staff-list"]);
            }, function (err) {
              _this47.notificationService.warning("Error", "Account creation was unsuccessful");

              _this47.errorService.handleError(err.error.message || err.error.details);
            });
          }
        }]);
...
//# sourceMappingURL=default-node_modules_angular_material___ivy_ngcc___fesm2015_table_js-src_app_user_user_service_ts-es5.js.map